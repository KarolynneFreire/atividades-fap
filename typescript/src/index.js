...
// }
var ingresso = readlineSync.question('Digite o tipo de ingresso (1 para VIP, 2 para standard): ');
if (ingresso !== '1' && ingresso !== '2') {
    console.log('Opção de ingresso inválida. Por favor, digite 1 para VIP ou 2 para standard.');
}
else {
    var combo = readlineSync.question('Deseja o combo de pipoca e refrigerante? (1 para Sim, 2 para Não): ');
    if (combo !== '1' && combo !== '2') {
